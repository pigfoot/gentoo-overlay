...
EGO_SUM=(
	...
	"github.com/certifi/gocertifi v0.0.0-20200211180108-c7c1fbc02894/go.mod"
	...
	"github.com/cloudflare/brotli-go v0.0.0-20191101163834-d34379f7ff93/go.mod"
	"github.com/cloudflare/cloudflare-go v0.10.2/go.mod"
	"github.com/cloudflare/golibs v0.0.0-20170913112048-333127dbecfc"
	"github.com/cloudflare/golibs v0.0.0-20170913112048-333127dbecfc/go.mod"
	...
	"github.com/coredns/coredns v1.7.0/go.mod"
	"github.com/coreos/go-oidc v0.0.0-20171002155002-a93f71fdfe73"
	"github.com/coreos/go-oidc v0.0.0-20171002155002-a93f71fdfe73/go.mod"
	...
	"github.com/facebookgo/grace v0.0.0-20180706040059-75cf19382434/go.mod"
	...
	"github.com/getsentry/raven-go v0.0.0-20180517221441-ed7bcb39ff10/go.mod"
	...
	"github.com/ipostelnik/cli/v2 v2.3.1-0.20210324024421-b6ea8234fe3d"
	"github.com/ipostelnik/cli/v2 v2.3.1-0.20210324024421-b6ea8234fe3d/go.mod"
	...
	"github.com/rivo/tview v0.0.0-20200712113419-c65badfc3d92/go.mod"
	...
	"gopkg.in/coreos/go-oidc.v2 v2.1.0/go.mod"
	...
	"zombiezen.com/go/capnproto2 v2.18.0+incompatible/go.mod"
)
